		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.gaochong.model.Order o=(com.gaochong.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.gaochong.dao.UserDao userDao=new com.gaochong.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.gaochong.model.Payment.findByPaymentId(con,n);
						%>
